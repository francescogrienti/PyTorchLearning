...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, trg_vocab_size, src_pad_idx, trg_pad_idx, embed_size=256, num_layers=6, heads=8,
                 device="cpu", forward_expansion=4, dropout=0, max_length=100):
