...
def create_params_table(hyperparams, vals) -> None:
    ...
    plt.tight_layout()
    plt.savefig(f'../plots/vit-pretrained/{exp_name}/hyperparams_pret_{exp_name}.png', dpi=300, bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_model_path', type=str, default=f'../plots/mae/checkpoints/large/vit-t-mae.pt')
    ...
    np.savetxt('../plots/vit-pretrained/values/large/train_loss.txt', train_loss_arr)
    np.savetxt('../plots/vit-pretrained/values/large/test_loss.txt', test_loss_arr)
    np.savetxt('../plots/vit-pretrained/values/large/train_acc.txt', train_acc_arr)
    np.savetxt('../plots/vit-pretrained/values/large/test_acc.txt', test_acc_arr)
    ...
    ax0.set_title('Loss function - ViT-pretrained')
    ...
    ax1.set_title('Accuracy function - ViT-pretrained')

    # Adjust layout to prevent overlap
    plt.tight_layout()
    # Show the plot
    plt.savefig(f'../plots/vit-pretrained/{exp_name}/ViT_loss_accuracy_pretrained_{exp_name}.png', dpi=300,
                bbox_inches='tight')
    plt.show()
