...
if __name__ == '__main__':
    ...
    if args.pretrained_model_path is not None:
        model = MAE_ViT()
        model.load_state_dict(torch.load(args.pretrained_model_path, map_location=device, weights_only=False))
    ...
    np.savetxt('../plots/vit-scratch/values/large/train_loss.txt', train_loss_arr)
    np.savetxt('../plots/vit-scratch/values/large/test_loss.txt', test_loss_arr)
    np.savetxt('../plots/vit-scratch/values/large/train_acc.txt', train_acc_arr)
    np.savetxt('../plots/vit-scratch/values/large/test_acc.txt', test_acc_arr)
